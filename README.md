...
Есть пример для esp8266 в нем мигают точки, цифры статичны, чтобы сделать часы с wi-fi нужно разобратся как обновлять разряды, сами по себе они обновляются не корректно.  
